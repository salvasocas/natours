  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51O2QAhAjfYln34LPCCAPL2v2K9lroMNKLBgvq0ingPxhNoN1UbTesV5NqMXujEyJRL8J7Ryl2ld2UiPnIpY6RK0r00ZLsjVhUA');
          _context.next = 4;
...
var updatePhotoBtn = document.querySelector('.form__upload');
...
if (updatePhotoBtn) {
  updatePhotoBtn.addEventListener('change', function (e) {
    document.querySelector('.photo__upload').textContent = 'Press save settings';
  });
}
