...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // everything correct send jwt to the client
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!currentUser) {
    return next(
      new appError(
        'The userr belonging to this token does no longer exist',
        401
      )
    );
  }
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 2. If token has not expired, and the is a user, set the new password
  if (!user) {
